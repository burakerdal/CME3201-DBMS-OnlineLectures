<%@ Page Title="StudentHome" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default_Student.aspx.cs" Inherits="OnlineLecturesSite.Default_Student" %>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="jumbotron">                 
                ...
                <hr />
                &raquo; <asp:LinkButton ID="LinkButton2" runat="server" Text="Kurs Al" OnClick="LinkButton2_Click" />
                <br />
                <br />
            </div>
        </div>
